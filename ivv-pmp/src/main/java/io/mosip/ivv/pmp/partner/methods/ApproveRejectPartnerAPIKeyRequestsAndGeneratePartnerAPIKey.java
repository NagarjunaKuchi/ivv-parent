...
public class ApproveRejectPartnerAPIKeyRequestsAndGeneratePartnerAPIKey extends Step implements StepInterface{
	...
	public void run(io.mosip.ivv.core.structures.Scenario.Step step) {
		...
		request_json.put("status", partner.getStatus());
		
		JSONObject api_input = new JSONObject();
		api_input.put("id", "mosip.partnermanagement.partners.apikey.approval");
